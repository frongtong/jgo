...
@php
    $browserTabTitle = 'Backend';
    if (!empty($navs) && !empty($navs[0]['name'])) {
        $browserTabTitle = $navs[0]['name'];
    }
@endphp
<title>JGO - {{ $browserTabTitle }}</title>
<meta charset="utf-8" />
...
<link href="{{asset("backend/assets/css/fonts.googleapis.css")}}" rel="stylesheet" type="text/css" />
