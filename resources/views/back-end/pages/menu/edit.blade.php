                ...
                <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                    <div class="d-flex flex-column flex-column-fluid">
                        <div id="kt_app_content" class="app-content  flex-column-fluid ">
							<form id="form_submit" action="{{ route('webpanel.menu.update', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="ชื่อ_ไทย" name="name_th" id="name_th" value="{{ $data->name_th }}" required>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label">ชื่อ_อังกฤษ</label>
                                                        <input type="text" class="form-control"
                                                            placeholder="ชื่อ_อังกฤษ" name="name_en" id="name_en" value="{{ $data->name_en }}" required>
                                                    </div>
                                                </div>
