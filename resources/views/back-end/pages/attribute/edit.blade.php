                            ...
                            <div id="kt_app_content_container" class="app-container  container-xxl ">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form id="form_submit"
                                            action="{{ route('webpanel.attribute.update', ['id' => $data->id]) }}"
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input name="name_th" type="text" class="form-control"
                                                            placeholder="ชื่อ_ไทย" value="{{ $data->name_th }}">
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label">ชื่อ_อังกฤษ</label>
                                                        <input name="name_en" type="text" class="form-control"
                                                            placeholder="ชื่อ_อังกฤษ" value="{{ $data->name_en }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="intro-y col-span-12 sm:col-span-6">
                                                        ...
                                                        <div class="intro-y col-span-12 sm:col-span-6">
                                                            ...
                                                            <img src="{{ asset('upload/Attribute/'.$data->img) }}" style="width:121px"
    ...
    function delete_path_img_url(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: "{{ url('/webpanel/brand/destroy/url') }}",
                        data: {
                            id: id,
