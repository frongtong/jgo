                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                <div class="card card-flush">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="hidden md:block mx-auto text-slate-500"><br><b>Showing
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                ...
                                                <thead>
                                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th style="width:45%;" class="text-center">รูปภาพ</th>
                                                        <!-- <th style="width:25%;" class="text-center">ชื่อ</th> -->
                                                ...
                                                <tbody>
                                                    @if (@$items->count() > 0)
                                                        @foreach (@$items as $index => $item)
                                                            <tr>
                                                                <td class="text-center menu-layout">
                                                                    {{ $items->pages->start + $index + 1 }}
                                                                </td>
                                                                <td> <img src="{{ asset($item->image) }}" alt="" width="100%"></td>
                                                                <!-- <td class="text-center menu-layout">{{ $item->name }}</td> -->
