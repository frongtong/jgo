...
<div class="top-bar">
    ...
    <div class="intro-x relative mr-3 sm:mr-6">
        ...
        <a class="notification sm:hidden" href="">
            <x-icon name="search" class="notification__icon dark:text-slate-500"/>
        </a>
    ...
    <div class="intro-x dropdown mr-auto sm:mr-6">
        <div class="dropdown-toggle notification notification--bullet cursor-pointer" role="button" aria-expanded="false" data-tw-toggle="dropdown">
            <x-icon name="bell" class="notification__icon dark:text-slate-500"/>
        </div>
            ...
            <ul class="dropdown-content bg-primary text-white">
                ...
                <li>
                    <a href="" class="dropdown-item hover:bg-white/5">
                        <x-icon name="user" class="w-4 h-4 mr-2"/> Profile
                    </a>
                </li>
                <li>
                    <a href="" class="dropdown-item hover:bg-white/5">
                        <x-icon name="user-cog" class="w-4 h-4 mr-2"/> Add Account
                    </a>
                </li>
                <li>
                    <a href="" class="dropdown-item hover:bg-white/5">
                        <x-icon name="lock" class="w-4 h-4 mr-2"/> Reset Password
                    </a>
                </li>
                <li>
                    <a href="" class="dropdown-item hover:bg-white/5">
                        <x-icon name="help-circle" class="w-4 h-4 mr-2"/> Help
                    </a>
                </li>
                <li><hr class="dropdown-divider border-white/[0.08]"></li>
                <li>
                    <a href="{{ route('logout') }}" class="dropdown-item hover:bg-white/5">
                        <x-icon name="toggle-right" class="w-4 h-4 mr-2"/> Logout
                    </a>
                </li>
            </ul>
        </div>
