...
class VideoCategory1Controller extends Controller
{
    protected $segment = 'webpanel';
    protected $prefix = 'back-end';
    protected $folder = 'videoctegory1';
    public function items($parameters)
    {
        $search = Arr::get($parameters, 'search');
        // $sort = Arr::get($parameters, 'sort', 'asc');
        $paginate = Arr::get($parameters, 'total', 15);
        $query = new VideoCategory1;
        if ($search) {
    ...
    public function index(Request $request)
    {
        ...
        $items = VideoCategory1::query()->paginate(15);
        $items->pages = new VideoCategory1();
    ...
    //     $datas = VideoCategory1::find(explode(',', $request->id));
    //     if (@$datas) {
    //         foreach ($datas as $data) {
    //             $query = VideoCategory1::destroy($data->id);
    //         }
    //     }
    ...
    {
        try {
            $item = VideoCategory1::find($request->id);
