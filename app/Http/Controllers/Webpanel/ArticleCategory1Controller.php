...
class ArticleCategory1Controller extends Controller
{
    protected $segment = 'webpanel';
    protected $prefix = 'back-end';
    protected $folder = 'arcategory1';
    public function items($parameters)
    {
        $search = Arr::get($parameters, 'search');
        // $sort = Arr::get($parameters, 'sort', 'asc');
        $paginate = Arr::get($parameters, 'total', 15);
        $query = new ArticleCategory1;
        if ($search) {
    ...
    public function index(Request $request)
    {
        ...
        $items = ArticleCategory1::query()->paginate(15);
        $items->pages = new ArticleCategory1();
    ...
    //     $datas = ArticleCategory1::find(explode(',', $request->id));
    //     if (@$datas) {
    //         foreach ($datas as $data) {
    //             $query = ArticleCategory1::destroy($data->id);
    //         }
    //     }
    ...
    {
        try {
            $item = ArticleCategory1::find($request->id);
